...
namespace HybridPlayerController
{
    public class SprintState : IState
    {
        ...
        {
            //MOVE
            player.SetMoveSpeed(player.sprintSpeed);
            //MOVE
            ...
            if (player.playerControls.BaseMovement.Crouch.triggered && player.isGrounded && player.canSlide)
            {
                player.TransitionToState<SlideState>();
                return;
            }
        ...
        private string PlayerPrefsKey => "SprintState_Unlocked";
